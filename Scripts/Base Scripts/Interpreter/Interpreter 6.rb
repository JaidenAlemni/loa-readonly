...
class Interpreter
  ...
  #--------------------------------------------------------------------------
  def command_301
    # Override troop ID if provided variable is set
    if $game_variables[BattleConfig::TROOP_OVERRIDE_ID] != 0
      @parameters[0] = $game_variables[BattleConfig::TROOP_OVERRIDE_ID]
      $game_variables[BattleConfig::TROOP_OVERRIDE_ID] = 0
    end
